 ...
 */
     ...
     */
        ...
        public static function attempt($credentials = [], $remember = false)
        {
                    ...
                    /**
         * Attempt to authenticate a users with credentials and additional callbacks.
         *
         * @param array $credentials
        ...
        public static function logout()
        {
                    ...
                    /**
         * Log the users out of the application on their current device only.
         *
        ...
        public static function logoutCurrentDevice()
        {
                    ...
                    /**
         * Invalidate other sessions for the current users.
         *
        ...
        public static function setRequest($request)
        {
                    ...
                    /**
         * Determine if the current users is authenticated. If not, throw an exception.
         *
         * @return \App\Models\User
         * @throws \Illuminate\Auth\AuthenticationException
         * @static
     ...
     */
        ...
        public static function denies($ability, $arguments = [])
        {
                    ...
                    /**
         * Determine if all of the given abilities should be granted for the current users.
         *
        ...
        public static function check($abilities, $arguments = [])
        {
                    ...
                    /**
         * Determine if any one of the given abilities should be granted for the current users.
         *
         * @param \Illuminate\Auth\Access\iterable|string $abilities
         * @param array|mixed $arguments
         * @return bool
        ...
        public static function any($abilities, $arguments = [])
        {
                    ...
                    /**
         * Determine if all of the given abilities should be denied for the current users.
         *
         * @param \Illuminate\Auth\Access\iterable|string $abilities
         * @param array|mixed $arguments
         * @return bool
        ...
        public static function authorize($ability, $arguments = [])
        {
                    ...
                    /**
         * Inspect the users for the given ability.
         *
         * @param string $ability
         * @param array|mixed $arguments
         * @return \Illuminate\Auth\Access\Response
     ...
     */
         ...
         * Gets the users info.
         *
         * @return string|null A users name if any and, optionally, scheme-specific information about how to gain authorization to access the server
         * @static
         */
        ...
        {            //Method inherited from \Symfony\Component\HttpFoundation\Request
                    ...
                    /**
         * Gets a list of languages acceptable by the client browser ordered in the users browser preferences.
         *
         * @static
         */
     ...
     */
        ...
        public static function setPreviousUrl($url)
        {
                    ...
                    /**
         * Specify that the users has confirmed their password.
         *
         * @return void
         * @static
         */
