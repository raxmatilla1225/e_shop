...
<html lang="en">
    <head>
        <!-- Title -->
        <title>Blog-v2 | Electro - Responsive Website Template</title>
                    ...
                    <div class="col-xl-9 col-wd">
                        <div class="max-width-1100-wd">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <article class="card mb-13 border-0">
                                        <a href="../blog/single-blog-post.html" class="d-block"><img class="img-fluid" src="../../assets/img/1500X730/img9.jpg" alt="Image Description"></a>
                                        <div class="card-body pt-5 pb-0 px-0">
