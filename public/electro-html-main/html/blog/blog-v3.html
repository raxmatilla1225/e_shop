...
<html lang="en">
    <head>
        <!-- Title -->
        <title>Blog-v3 | Electro - Responsive Website Template</title>
                    ...
                    <div class="col-xl-9 col-wd">
                        <div class="min-width-1100-wd">
                            ...
                            <article class="card mb-13 border-0">
                                <div class="row">
                                    <div class="col-lg-4 mb-5 mb-lg-0">
                                        <a href="../blog/single-blog-post.html" class="d-block"><img class="img-fluid min-height-250 object-fit-cover" src="../../assets/img/1500X730/img7.jpg" alt="Image Description"></a>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="card-body p-0">
                            ...
                            <article class="card mb-13 border-0">
                                <div class="row">
                                    <div class="col-lg-4 mb-5 mb-lg-0">
                                        <a href="../blog/single-blog-post.html" class="d-block"><img class="img-fluid min-height-250 object-fit-cover" src="../../assets/img/1500X730/img4.jpg" alt="Image Description"></a>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="card-body p-0">
                            ...
                            <article class="card mb-13 border-0">
                                <div class="row">
                                    <div class="col-lg-4 mb-5 mb-lg-0">
                                        <a href="../blog/single-blog-post.html" class="d-block"><img class="img-fluid min-height-250 object-fit-cover" src="../../assets/img/1500X730/img8.jpg" alt="Image Description"></a>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="card-body p-0">
