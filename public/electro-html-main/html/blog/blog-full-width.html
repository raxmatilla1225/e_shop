...
<html lang="en">
    <head>
        <!-- Title -->
        <title>Blog Fullwidth | Electro - Responsive Website Template</title>
            ...
            <div class="container">
                <div class="border-bottom mb-6 pb-2">
                    <ul class="nav list-unstyled justify-content-center list-divider">
                        <li class="nav-item flex-horizontal-center m-0"><a class="nav-link text-gray-90 underline-on-hover px-1" title="Technology" href="../blog/single-blog-post.html">Technology</a></li>
                        <li class="nav-item flex-horizontal-center m-0"><a class="nav-link text-gray-90 underline-on-hover px-1" title="Design" href="../blog/single-blog-post.html">Design</a></li>
                        <li class="nav-item flex-horizontal-center m-0"><a class="nav-link text-gray-90 underline-on-hover px-1" title="News" href="../blog/single-blog-post.html">News</a></li>
                        <li class="nav-item flex-horizontal-center m-0"><a class="nav-link text-gray-90 underline-on-hover px-1" title="Events" href="../blog/single-blog-post.html">Events</a></li>
                        <li class="nav-item flex-horizontal-center m-0"><a class="nav-link text-gray-90 underline-on-hover px-1" title="Links &amp; Quotes" href="../blog/single-blog-post.html">Links &amp; Quotes</a></li>
                        <li class="nav-item flex-horizontal-center m-0"><a class="nav-link text-gray-90 underline-on-hover px-1" title="Videos" href="../blog/single-blog-post.html">Videos</a></li>
                    </ul>
                </div>
                <div class="mb-5">
                    ...
                    <article class="card mb-8 border-0">
                        <div class="card-body p-5 p-md-10 bg-gray-1">
                            <p class="d-block font-size-25 text-gray-39">If you are looking for a developer on TemplateMonster – check out the link</p>
                            <a href="../blog/single-blog-post.html" class="text-blue">http://wwww.example.com</a>
                        </div>
                    </article>
                </div>
                <!-- Brand Carousel -->
