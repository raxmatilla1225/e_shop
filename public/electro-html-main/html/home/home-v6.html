...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="flex-content-center">
                            <div class="font-size-13">
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item u-header-topbar__nav-item u-header-topbar__nav-item-no-border"><a class="text-gray-90" title="30 days free return" href="javascript:;">30 DAYS FREE RETURN</a></li>
                                    <li class="list-inline-item u-header-topbar__nav-item u-header-topbar__nav-item-no-border"><a class="text-gray-90" title="FREE SHIPPING  FOR OVER $40" href="javascript:;">FREE SHIPPING FOR OVER $40</a></li>
                                    <li class="list-inline-item u-header-topbar__nav-item u-header-topbar__nav-item-no-border"><a class="text-gray-90" title="BEST WORLDWIDE DELIVERY" href="javascript:;">BEST WORLDWIDE DELIVERY</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="d-none d-xl-block col-xl-5">
                                <ul class="list-inline mb-0">
                                    ...
                                    <li class="list-inline-item u-header-topbar__nav-item u-header-topbar__nav-item-no-border">
                                        <a href="mailto:info@example.com" class="u-header-topbar__nav-link"><i class="ec ec-mail mr-1"></i> info@example.com</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- End Contact -->
                            ...
                            <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                <ul class="navbar-nav u-header__navbar-nav justify-content-center">
                                    ...
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="javascript:;" aria-haspopup="true" aria-expanded="false" aria-labelledby="featuresSubMenu">Features</a>
                                    </li>
                                    <!-- End Features -->

                                    <!-- About Us -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="javascript:;" aria-haspopup="true" aria-expanded="false" aria-labelledby="AboutUsSubMenu">About Us</a>
                                    </li>
                                    <!-- End About Us -->

                                    <!-- Contact Us -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="javascript:;" aria-haspopup="true" aria-expanded="false">Contact Us</a>
                                    </li>
                                    <!-- End Contact Us -->
                                </ul>
                            </div>
        ...
        <main id="content" role="main">
            <!-- Slider Section -->
            <div class="mb-5">
                <div class="bg-img-hero" style="background-image: url(../../assets/img/1920X714/img1.jpg);">
                    <div class="container">
                        <div class="mb-6 pt-3">
                                        ...
                                        <div class="tab-pane fade show active" id="pills-one-code-features" role="tabpanel" aria-labelledby="pills-one-code-features-tab">
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col-lg-7"
                                                    ...
                                                    <img class="img-fluid rounded-lg" src="../../assets/img/724X360/img2.png" alt="Image Description">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="pills-two-code-features" role="tabpanel" aria-labelledby="pills-two-code-features-tab">
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col-lg-7"
                                                    data-scs-animation-in="zoomIn"
                                                    data-scs-animation-delay="500">
                                                    <img class="img-fluid rounded-lg" src="../../assets/img/724X360/img1.png" alt="Image Description">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="pills-three-code-features" role="tabpanel" aria-labelledby="pills-three-code-features-tab">
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col-lg-7"
                                                    data-scs-animation-in="zoomIn"
                                                    data-scs-animation-delay="500">
                                                    <img class="img-fluid rounded-lg" src="../../assets/img/724X360/img3.png" alt="Image Description">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="pills-four-code-features" role="tabpanel" aria-labelledby="pills-four-code-features-tab">
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col-lg-7"
                                                    data-scs-animation-in="zoomIn"
                                                    data-scs-animation-delay="500">
                                                    <img class="img-fluid rounded-lg" src="../../assets/img/724X360/img4.png" alt="Image Description">
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="container">
                ...
                <div class="mb-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg">
                            <a href="../shop/shop.html" class="d-block"><img class="img-fluid" src="../../assets/img/390X370/img1.jpg" alt="Image Description"></a>
                        </div>
                        <div class="col-md-6 pl-md-0 col-lg-8gdot46">
                            <!-- Tab Content -->
                            <div class="tab-content overflow-hidden pr-0dot5" id="Dpills-tabContent">
                ...
                <div class="mb-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg">
                            <a href="../shop/shop.html" class="d-block"><img class="img-fluid" src="../../assets/img/390X270/img1.jpg" alt="Image Description"></a>
                        </div>
                        <div class="col-md-6 pl-md-0 col-lg-8gdot46">
                            <!-- Tab Content -->
                            <div class="tab-content overflow-hidden pr-0dot5" id="Kpills-tabContent">
