...
<html lang="en">
    <head>
        <!-- Title -->
        <title>Store Directory | Electro - Responsive Website Template</title>
                            ...
                            <div class="d-none d-xl-block col-md-auto">
                                <div class="d-flex">
                                    ...
                                    <div class="ml-2">
                                        ...
                                        <div class="email">
                                            E-mail: <a href="mailto:info@example.com?subject=Help Need" class="text-gray-90">info@example.com</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="mb-8">
                    <div class="row no-gutters ec-store-directory align-items-start">
                        <ul class="col-md-3 border-top border-color-1 mb-4 mb-md-0">
                            <li><a href="javascript:;">12.3 inch</a></li>
                            <li><a href="javascript:;">Ending Offers</a></li>
                            <li><a href="javascript:;">Gadgets</a>
                                <ul>
                                    <li><a href="javascript:;">Gadgets &amp; Accesories</a></li>
                                    <li><a href="javascript:;">Smartwatches</a></li>
                                    <li><a href="javascript:;">Wearables</a></li>
                                </ul>
                            </li>
                            <li><a href="javascript:;">Smart Phones &amp; Tablets</a>
                                <ul>
                                    <li><a href="javascript:;">Accessories</a></li>
                                    <li><a href="javascript:;">Chargers</a></li>
                                    <li><a href="javascript:;">Powerbanks</a></li>
                                    <li><a href="javascript:;">Smartphones</a>
                                        <ul>
                                            <li><a href="javascript:;">4G LTE Smartphone</a></li>
                                            <li><a href="javascript:;">Cables</a></li>
                                            <li><a href="javascript:;">Chargers</a></li>
                                            <li><a href="javascript:;">Covers</a></li>
                                            <li><a href="javascript:;">Featured Phones</a></li>
                                            <li><a href="javascript:;">Holders</a></li>
                                            <li><a href="javascript:;">Mobile Phones</a></li>
                                            <li><a href="javascript:;">Mobiles Accesories</a></li>
                                            <li><a href="javascript:;">Powerbanks</a></li>
                                            <li><a href="javascript:;">Unlocked Phone</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="javascript:;">Smartphones &amp; Tablets</a></li>
                                    <li><a href="javascript:;">Smartphones &amp; Tablets</a></li>
                                    <li><a href="javascript:;">Tablets</a>
                                        <ul>
                                            <li><a href="javascript:;">Featured Tablets</a></li>
                                            <li><a href="javascript:;">Tablet Accesories</a></li>
                                            <li><a href="javascript:;">Tablet Accessories</a></li>
                                            <li><a href="javascript:;">Tablet PCs</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            <li><a href="javascript:;">TV &amp; Audio</a>
                                <ul>
                                    <li><a href="javascript:;">Audio</a></li>
                                    <li><a href="javascript:;">Audio Speakers</a></li>
                                    <li><a href="javascript:;">Portable Audio</a></li>
                                </ul>
                            </li>
                        </ul>
                        <ul class="col-md-3 border-top border-color-1 mb-4 mb-md-0">
                            <li><a href="javascript:;">15 inch</a></li>
                            <li><a href="javascript:;">Computer Components</a>
                                <ul>
                                    <li><a href="javascript:;">Computer Cases</a></li>
                            ...
                            <li><a href="javascript:;">Gadgets &amp; Accesories</a></li>
                            <li><a href="javascript:;">Printers &amp; Ink</a>
                                <ul>
                                    <li><a href="javascript:;">Printers</a></li>
                                </ul>
                            </li>
                            <li><a href="javascript:;">Uncategorized</a></li>
                        </ul>
                        <ul class="col-md-3 border-top border-color-1 mb-4 mb-md-0">
                            <li><a href="javascript:;">17 inch</a></li>
                            <li><a href="javascript:;">Car Electronic &amp; GPS</a></li>
                            <li><a href="javascript:;">GPS &amp; Navi</a></li>
                            <li><a href="javascript:;">Office Supplies</a></li>
                            <li><a href="javascript:;">Video Games &amp; Consoles</a>
                                <ul>
                                    <li><a href="javascript:;">Accessories</a></li>
                                    <li><a href="javascript:;">Action Games</a></li>
                                    <li><a href="javascript:;">Game Consoles</a></li>
                                    <li><a href="javascript:;">Racing Games</a></li>
                                    <li><a href="javascript:;">Station Consoles</a></li>
                                    <li><a href="javascript:;">Video Games &amp; Consoles</a></li>
                                    <li><a href="javascript:;">Xbox</a></li>
                                </ul>
                            </li>
                        </ul>
                        <ul class="col-md-3 border-top border-color-1 mb-4 mb-md-0">
                            <li><a href="/accessories/">Accessories</a>
                                <ul>
                                    ...
                                    <li><a href="javascript:;">Chargers</a></li>
                                    <li><a href="javascript:;">Headphone Accessories</a></li>
                                    <li><a href="javascript:;">Headphone Cases</a></li>
                                    <li><a href="javascript:;">Headphones</a>
                                        <ul>
                                            <li><a href="javascript:;">Earbuds and In-ear</a></li>
                                            <li><a href="javascript:;">Kids' Headphones</a></li>
                                            <li><a href="javascript:;">Over-Ear and On-Ear</a></li>
                                            <li><a href="javascript:;">PC Gaming Headsets</a></li>
                                            <li><a href="javascript:;">Pro &amp; DJ Headphones</a></li>
                                            <li><a href="javascript:;">Refurbished Headphones</a></li>
                                            <li><a href="javascript:;">Refurbished Headphones</a></li>
                                            <li><a href="javascript:;">Waterproof Headphones</a></li>
                                            <li><a href="javascript:;">Wireless and Bluetooth</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="javascript:;">Pendrives</a></li>
                                    <li><a href="javascript:;">Power Banks</a></li>
                                </ul>
                            </li>
                            <li><a href="javascript:;">Cameras &amp; Photography</a>
                                <ul>
                                    <li><a href="javascript:;">Cameras</a></li>
                                    <li><a href="javascript:;">Photo Cameras</a></li>
                                    <li><a href="javascript:;">Photo Cameras</a></li>
                                    <li><a href="javascript:;">Video Cameras</a></li>
                                </ul>
                            </li>
                            <li><a href="javascript:;">Home Entertainment</a>
                                <ul>
                                    <li><a href="javascript:;">Blue-ray Players</a></li>
                                    <li><a href="javascript:;">DVD Players</a></li>
                                    <li><a href="javascript:;">Home &amp; Audio Enternteinment</a></li>
                                    <li><a href="javascript:;">Home &amp; Audio Enternteinment</a></li>
                                    <li><a href="javascript:;">Home Theatres</a></li>
                                    <li><a href="javascript:;">Projectors</a></li>
                                    <li><a href="javascript:;">Speakers</a></li>
                                    <li><a href="javascript:;">TVs</a>
                                        <ul>
                                            <li><a href="javascript:;">3D Tvs</a></li>
                                            <li><a href="javascript:;">4k Ultra HD TVs</a></li>
                                            <li><a href="javascript:;">Curved TVs</a></li>
                                            <li><a href="javascript:;">LED TVs</a></li>
                                            <li><a href="javascript:;">OLED TVs</a></li>
                                            <li><a href="javascript:;">Smart TVs</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            <li><a href="javascript:;">Laptops &amp; Computers</a>
                                <ul>
                                    <li><a href="javascript:;">Accessories</a></li>
                                    <li><a href="javascript:;">All in One</a></li>
                                    <li><a href="javascript:;">Computer Accessories</a></li>
                                    <li><a href="javascript:;">Computer Monitors</a></li>
                                    <li><a href="javascript:;">Computers</a></li>
                                    <li><a href="javascript:;">Desktop Computers</a></li>
                                    <li><a href="javascript:;">Desktop PCs &amp; Laptops</a></li>
                                    <li><a href="javascript:;">Desktop PCs &amp; Laptops</a></li>
                                    <li><a href="javascript:;">Gaming</a></li>
                                    <li><a href="javascript:;">Laptops</a></li>
                                    <li><a href="javascript:;">Mac Computers</a></li>
                                    <li><a href="javascript:;">Networking</a></li>
                                    <li><a href="javascript:;">Notebooks</a></li>
                                    <li><a href="javascript:;">Peripherals</a></li>
                                    <li><a href="javascript:;">Refurbished Laptops</a></li>
                                    <li><a href="javascript:;">Servers</a></li>
                                    <li><a href="javascript:;">Software</a></li>
                                    <li><a href="javascript:;">Ultrabooks</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                                        ...
                                        <li>
                                            ...
                                            <div id="sidebarNav1Collapse" class="collapse" data-parent="#sidebarNav">
                                                <ul id="sidebarNav1" class="list-unstyled dropdown-list">
                                                    <!-- Menu List -->
                                                    <li><a class="dropdown-item" href="javascript:;">Accessories<span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></a></li>
                                                    <li><a class="dropdown-item" href="javascript:;">Cameras & Photography<span class="text-gray-25 font-size-12 font-weight-normal"> (11)</span></a></li>
                                                    <li><a class="dropdown-item" href="javascript:;">Computer Components<span class="text-gray-25 font-size-12 font-weight-normal"> (22)</span></a></li>
                                                    <li><a class="dropdown-item" href="javascript:;">Gadgets<span class="text-gray-25 font-size-12 font-weight-normal"> (5)</span></a></li>
                                                    <li><a class="dropdown-item" href="javascript:;">Home Entertainment<span class="text-gray-25 font-size-12 font-weight-normal"> (7)</span></a></li>
                                                    <li><a class="dropdown-item" href="javascript:;">Laptops & Computers<span class="text-gray-25 font-size-12 font-weight-normal"> (42)</span></a></li>
                                                    <li><a class="dropdown-item" href="javascript:;">Printers & Ink<span class="text-gray-25 font-size-12 font-weight-normal"> (63)</span></a></li>
                                                    <li><a class="dropdown-item" href="javascript:;">Smart Phones & Tablets<span class="text-gray-25 font-size-12 font-weight-normal"> (11)</span></a></li>
                                                    <li><a class="dropdown-item" href="javascript:;">TV & Audio<span class="text-gray-25 font-size-12 font-weight-normal"> (66)</span></a></li>
                                                    <li><a class="dropdown-item" href="javascript:;">Video Games & Consoles<span class="text-gray-25 font-size-12 font-weight-normal"> (31)</span></a></li>
                                                    <!-- End Menu List -->
                                                </ul>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div id="sidebarNav2Collapse" class="collapse" data-parent="#sidebarNav">
                                                <ul id="sidebarNav2" class="list-unstyled dropdown-list">
                                                    <!-- Menu List -->
                                                    <li><a class="dropdown-item" href="javascript:;">Cameras<span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></a></li>
                                                    <!-- End Menu List -->
                                                </ul>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div id="sidebarNav3Collapse" class="collapse" data-parent="#sidebarNav">
                                                <ul id="sidebarNav3" class="list-unstyled dropdown-list">
                                                    <!-- Menu List -->
                                                    <li><a class="dropdown-item" href="javascript:;">Computer Cases<span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></a></li>
                                                    <!-- End Menu List -->
                                                </ul>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div id="sidebarNav4Collapse" class="collapse" data-parent="#sidebarNav">
                                                <ul id="sidebarNav4" class="list-unstyled dropdown-list">
                                                    <!-- Menu List -->
                                                    <li><a class="dropdown-item" href="javascript:;">Smartwatches<span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></a></li>
                                                    <li><a class="dropdown-item" href="javascript:;">Wearables<span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></a></li>
                                                    <!-- End Menu List -->
                                                </ul>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div id="sidebarNav5Collapse" class="collapse" data-parent="#sidebarNav">
                                                <ul id="sidebarNav5" class="list-unstyled dropdown-list">
                                                    <!-- Menu List -->
                                                    <li><a class="dropdown-item" href="javascript:;">Tvs<span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></a></li>
                                                    <!-- End Menu List -->
                                                </ul>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            <div id="sidebarNav7Collapse" class="collapse" data-parent="#sidebarNav">
                                                <ul id="sidebarNav7" class="list-unstyled dropdown-list">
                                                    <!-- Menu List -->
                                                    <li><a class="dropdown-item" href="javascript:;">Printers<span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></a></li>
                                                    <!-- End Menu List -->
                                                </ul>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div id="sidebarNav8Collapse" class="collapse" data-parent="#sidebarNav">
                                                <ul id="sidebarNav8" class="list-unstyled dropdown-list">
                                                    <!-- Menu List -->
                                                    <li><a class="dropdown-item" href="javascript:;">Smartphones<span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></a></li>
                                                    <li><a class="dropdown-item" href="javascript:;">Tablets<span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></a></li>
                                                    <!-- End Menu List -->
                                                </ul>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div id="sidebarNav9Collapse" class="collapse" data-parent="#sidebarNav">
                                                <ul id="sidebarNav9" class="list-unstyled dropdown-list">
                                                    <!-- Menu List -->
                                                    <li><a class="dropdown-item" href="javascript:;">Audio Speakers<span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></a></li>
                                                    <!-- End Menu List -->
                                                </ul>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div id="sidebarNav10Collapse" class="collapse" data-parent="#sidebarNav">
                                                <ul id="sidebarNav10" class="list-unstyled dropdown-list">
                                                    <!-- Menu List -->
                                                    <li><a class="dropdown-item" href="javascript:;">Game Consoles<span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></a></li>
                                                    <!-- End Menu List -->
                                                </ul>
                                            </div>
                                        </li>
