...
<html lang="en">
    <head>
        <!-- Title -->
        <title>Home-v5 | Electro - Responsive Website Template</title>
                                ...
                                <div class="d-inline-flex d-xl-flex align-items-center justify-content-xl-between position-relative">
                                    ...
                                    <div id="logoAndNav">
                                        ...
                                        <nav class="navbar navbar-expand u-header__navbar">
                                            ...
                                            <!-- Logo -->
                                            <a class="navbar-brand u-header__navbar-brand u-header__navbar-brand-center ml-1 ml-xl-0" href="../home/index.html" aria-label="Electro">
                                                        ...
                                                        <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                                            <ul class="navbar-nav u-header__navbar-nav">
                                                                ...
                                                                <li class="nav-item u-header__nav-item"
                                                                    data-event="hover"
                                                                    data-position="left">
                                                                    <a href="javascript:;" class="nav-link u-header__nav-link font-weight-bold">New Arrivals</a>
                                                                </li>
                                                                <!-- Nav Item MegaMenu -->
                                                                        ...
                                                                        <div class="row u-header__mega-menu-wrapper">
                                                                            <div class="col mb-3 mb-sm-0">
                                                                                ...
                                                                                <ul class="u-header__sub-menu-nav-group mb-3">
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">All Computers & Accessories</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Laptops, Desktops & Monitors</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Printers & Ink</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Networking & Internet Devices</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Computer Accessories</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Software</a></li>
                                                                                    <li>
                                                                                        <a class="nav-link u-header__sub-menu-nav-link u-nav-divider border-top pt-2 flex-column align-items-start" href="javascript:;">
                                                                            ...
                                                                            <div class="col mb-3 mb-sm-0">
                                                                                ...
                                                                                <ul class="u-header__sub-menu-nav-group">
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">All Office & Stationery</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu1">
                                                                        ...
                                                                        <div class="row u-header__mega-menu-wrapper">
                                                                            <div class="col mb-3 mb-sm-0">
                                                                                ...
                                                                                <ul class="u-header__sub-menu-nav-group mb-3">
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Lenses</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Camera Accessories</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Security & Surveillance</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Binoculars & Telescopes</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Camcorders</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Software</a></li>
                                                                                    <li>
                                                                                        <a class="nav-link u-header__sub-menu-nav-link u-nav-divider border-top pt-2 flex-column align-items-start" href="javascript:;">
                                                                                            <div class="">All Electronics</div>
                                                                            ...
                                                                            <div class="col mb-3 mb-sm-0">
                                                                                ...
                                                                                <ul class="u-header__sub-menu-nav-group">
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">All Audio & Video</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Headphones & Speakers</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="hs-mega-menu vmm-tfw u-header__sub-menu vmm-bg-extended" aria-labelledby="basicMegaMenu2">
                                                                        ...
                                                                        <div class="row u-header__mega-menu-wrapper">
                                                                            <div class="col mb-3 mb-sm-0">
                                                                                ...
                                                                                <ul class="u-header__sub-menu-nav-group mb-3">
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">All Mobile Phones</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Smartphones</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Refurbished Mobiles</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link border-top pt-2" href="javascript:;">All Mobile Accessories</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Cases & Covers</a></li>
                                                                                    <li>
                                                                                        <a class="nav-link u-header__sub-menu-nav-link u-nav-divider border-top pt-2 flex-column align-items-start" href="javascript:;">
                                                                                            <div class="">All Electronics</div>
                                                                                            <div class="u-nav-subtext font-size-11 text-gray-30">Discover more products</div>
                                                                            ...
                                                                            <div class="col mb-3 mb-sm-0">
                                                                                <ul class="u-header__sub-menu-nav-group">
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">All Tablets</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Tablet Accessories</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu3">
                                                                        ...
                                                                        <div class="row u-header__mega-menu-wrapper">
                                                                            <div class="col mb-3 mb-sm-0">
                                                                                ...
                                                                                <ul class="u-header__sub-menu-nav-group mb-3">
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">All Movies & TV Shows</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">All English</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link border-bottom pb-3" href="javascript:;">All Hindi</a></li>
                                                                                </ul>
                                                                                <span class="u-header__sub-menu-title">Video Games</span>
                                                                                <ul class="u-header__sub-menu-nav-group">
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">PC Games</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Consoles</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Accessories</a></li>
                                                                                </ul>
                                                                            </div>
                                                                            ...
                                                                            <div class="col mb-3 mb-sm-0">
                                                                                ...
                                                                                <ul class="u-header__sub-menu-nav-group">
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">All Music</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Indian Classical</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Musical Instruments</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu4">
                                                                        ...
                                                                        <div class="row u-header__mega-menu-wrapper">
                                                                            <div class="col mb-3 mb-sm-0">
                                                                                ...
                                                                                <ul class="u-header__sub-menu-nav-group mb-3">
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">All Audio & Video</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Televisions</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Headphones</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Speakers</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Audio & Video Accessories</a></li>
                                                                                    <li>
                                                                                        <a class="nav-link u-header__sub-menu-nav-link u-nav-divider border-top pt-2 flex-column align-items-start" href="javascript:;">
                                                                    ...
                                                                    <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu5">
                                                                        ...
                                                                        <div class="row u-header__mega-menu-wrapper">
                                                                            <div class="col mb-3 mb-sm-0">
                                                                                ...
                                                                                <ul class="u-header__sub-menu-nav-group mb-3">
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">All Watches</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Men's Watches</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Women's Watches</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Premium Watches</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Deals on Watches</a></li>
                                                                                </ul>
                                                                            </div>
                                                                    ...
                                                                    <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu3">
                                                                        ...
                                                                        <div class="row u-header__mega-menu-wrapper">
                                                                            <div class="col mb-3 mb-sm-0">
                                                                                ...
                                                                                <ul class="u-header__sub-menu-nav-group mb-3">
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">All Cars & Bikes</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Car & Bike Care</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link border-bottom pb-3" href="javascript:;">Lubricants</a></li>
                                                                                </ul>
                                                                                <span class="u-header__sub-menu-title">Shop for Bike</span>
                                                                                <ul class="u-header__sub-menu-nav-group">
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Helmets & Gloves</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Bike Parts</a></li>
                                                                                </ul>
                                                                            </div>
                                                                            ...
                                                                            <div class="col mb-3 mb-sm-0">
                                                                                ...
                                                                                <ul class="u-header__sub-menu-nav-group">
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">All Industrial Supplies</a></li>
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="javascript:;">Lab & Scientific</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                            ...
                            <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                <ul class="navbar-nav u-header__navbar-nav u-header__navbar-nav-divider flex-wrap">
                                    ...
                                    <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                        ...
                                        data-animation-out="fadeOut"
                                        data-position="left">
                                        <a id="homeMegaMenu" class="nav-link u-header__nav-link u-header__nav-link-toggle text-sale" href="javascript:;" aria-haspopup="true" aria-expanded="false">Top Deals</a>
                                    ...
                                    <!-- Mobiles -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="javascript:;">Mobiles & Tablets Accessories</a>
                                    </li>
                                    <!-- End Mobiles -->

                                    <!-- Microsoft Surface Pro 3 -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="javascript:;">Microsoft Surface Pro 3</a>
                                    </li>
                                    <!-- End Microsoft Surface Pro 3 -->

                                    <!-- Smart Watches -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="javascript:;">Smart Watches</a>
                                    </li>
                                    <!-- End Smart Watches -->

                                    <!-- PlayStation 4 Pro Console -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="javascript:;">PlayStation 4 Pro Console</a>
                                    </li>
                                    <!-- End PlayStation 4 Pro Console -->

                                    <!-- Canon EOS 700D -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="javascript:;">Canon EOS 700D</a>
                                    </li>
                                    <!-- End Canon EOS 700D -->

                                    <!-- Home Appliances -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="javascript:;">Home Appliances</a>
                                    </li>
                                    <!-- End Home Appliances -->

                                    <!-- Samsung Smart TVs -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="javascript:;">Samsung Smart TVs</a>
                                    </li>
                                    <!-- End Samsung Smart TVs -->

                                    <!-- Button -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="font-weight-bold nav-link u-header__nav-link" href="javascript:;" aria-haspopup="true" aria-expanded="false" target="_blank">
                                            ...More
                                        </a>
                                    </li>
                                    <!-- End Button -->
            ...
            <div class="mb-8">
                <div class="container">
                    <div class="overflow-hidden">
                        <div class="bg-img-hero min-height-420" style="background-image: url(../../assets/img/1400X420/img1.jpg);">
                                ...
                                <div class="js-slide">
                                    <div class="row height-410-xl mx-0 align-items-center">
                                        ...
                                        <div class="col-md-4 d-flex align-items-center ml-auto ml-md-0 mb-4 mb-md-0"
                                            ...
                                            <img class="img-fluid" src="../../assets/img/400X400/img2.png" alt="Image Description">
                                        </div>
                                        <div class="col-md-4"
                                            data-scs-animation-in="fadeInRight"
                                            data-scs-animation-delay="600">
                                            <div class="mr-xl-14">
                                                <h5 class="mb-3 font-size-17 product-item__title text-lh-default"><a href="javascript:;" class="text-blue font-weight-bold">Widescreen 4K SUHD TV</a></h5>
                                ...
                                <div class="js-slide">
                                    <div class="row height-410-xl mx-0 align-items-center">
                                        ...
                                        <div class="col-md-4 d-flex align-items-center ml-auto ml-md-0 mb-4 mb-md-0"
                                            data-scs-animation-in="zoomIn"
                                            data-scs-animation-delay="400">
                                            <img class="img-fluid" src="../../assets/img/400X400/img1.png" alt="Image Description">
                                        </div>
                                        <div class="col-md-4"
                                            data-scs-animation-in="fadeInRight"
                                            data-scs-animation-delay="600">
                                            <div class="mr-xl-14">
                                                <h5 class="mb-3 font-size-17 product-item__title text-lh-default"><a href="javascript:;" class="text-blue font-weight-bold">Game Console Controller + USB 3.0 Cable</a></h5>
                                                <div class="prodcut-price d-flex align-items-end position-relative text-lh-1 mb-5">
                                                    <ins class="font-size-34 text-red text-decoration-none">$79.00</ins>
                                                    <del class="font-size-18 tex-gray-6 mb-1 ml-2">$99.00</del>
                                                </div>
                                ...
                                <div class="js-slide">
                                    <div class="row height-410-xl mx-0 align-items-center">
                                        ...
                                        <div class="col-md-4 d-flex align-items-center ml-auto ml-md-0 mb-4 mb-md-0"
                                            data-scs-animation-in="zoomIn"
                                            data-scs-animation-delay="400">
                                            <img class="img-fluid" src="../../assets/img/400X400/img3.png" alt="Image Description">
                                        </div>
                                        <div class="col-md-4"
                                            data-scs-animation-in="fadeInRight"
                                            data-scs-animation-delay="600">
                                            <div class="mr-xl-14">
                                                <h5 class="mb-3 font-size-17 product-item__title text-lh-default"><a href="javascript:;" class="text-blue font-weight-bold">Ultra Wireless S50 Headphones S50 with Bluetooth</a></h5>
                                                <div class="prodcut-price d-flex align-items-end position-relative text-lh-1 mb-5">
                                                    <ins class="font-size-34 text-red text-decoration-none">$79.00</ins>
                                                    <del class="font-size-18 tex-gray-6 mb-1 ml-2">$99.00</del>
                                                </div>
                                ...
                                <div class="js-slide">
                                    <div class="row height-410-xl mx-0 align-items-center">
                                        ...
                                        <div class="col-md-4 d-flex align-items-center ml-auto ml-md-0 mb-4 mb-md-0"
                                            data-scs-animation-in="zoomIn"
                                            data-scs-animation-delay="400">
                                            <img class="img-fluid" src="../../assets/img/400X400/img4.png" alt="Image Description">
                                        </div>
                                        <div class="col-md-4"
                                            data-scs-animation-in="fadeInRight"
                                            data-scs-animation-delay="600">
                                            <div class="mr-xl-14">
                                                <h5 class="mb-3 font-size-17 product-item__title text-lh-default"><a href="javascript:;" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360</a></h5>
                                                <div class="prodcut-price d-flex align-items-end position-relative text-lh-1 mb-5">
                                                    <ins class="font-size-34 text-red text-decoration-none">$79.00</ins>
                                                    <del class="font-size-18 tex-gray-6 mb-1 ml-2">$99.00</del>
                                                </div>
                                ...
                                <div class="js-slide">
                                    <div class="row height-410-xl mx-0 align-items-center">
                                        ...
                                        <div class="col-md-4 d-flex align-items-center ml-auto ml-md-0 mb-4 mb-md-0"
                                            data-scs-animation-in="zoomIn"
                                            data-scs-animation-delay="400">
                                            <img class="img-fluid" src="../../assets/img/400X400/img5.png" alt="Image Description">
                                        </div>
                                        <div class="col-md-4"
                                            data-scs-animation-in="fadeInRight"
                                            data-scs-animation-delay="600">
                                            <div class="mr-xl-14">
                                                <h5 class="mb-3 font-size-17 product-item__title text-lh-default"><a href="javascript:;" class="text-blue font-weight-bold">Tablet Red EliteBook  Revolve 810 G2</a></h5>
                                                <div class="prodcut-price d-flex align-items-end position-relative text-lh-1 mb-5">
                                                    <ins class="font-size-34 text-red text-decoration-none">$79.00</ins>
                                                    <del class="font-size-18 tex-gray-6 mb-1 ml-2">$99.00</del>
                                                </div>
            ...
            <div class="container">
                ...
                <div class="mb-6">
                    ...
                    <div class="position-relative z-index-2">
                        <div class=" d-flex justify-content-between border-bottom border-color-1 flex-lg-nowrap flex-wrap border-md-down-top-0 border-md-down-bottom-0">
                            <h3 class="section-title section-title__full mb-0 pb-2 font-size-22">Save Big on Warehouse Cleaning</h3>
                            ...
                            <a class="d-block text-gray-16" href="javascript:;">Go to Daily Deals Section <i class="ec ec-arrow-right-categproes"></i></a>
                        </div>
                        <!-- Tab Content -->
                ...
                <div class="mb-6">
                    <div class="row">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <div class="banner-bg">
                                <a href="../shop/shop.html" class="min-height-146 py-3 py-xl-3 py-wd-4 my-2 my-wd-1 d-inline-flex align-items-center text-gray-90">
                            ...
                            <div class="banner-bg">
                                <a href="../shop/shop.html" class="min-height-146 py-3 py-xl-3 py-wd-4 my-2 my-wd-1 d-inline-flex align-items-center text-gray-90">
                                    ...
                                    <div class="col-7 col-md-6 pr-xl-15 pr-wd-19">
                                        ...
                                        <div class="link text-gray-90" href="javascript:;">
                ...
                <div class="mb-6">
                    <div class=" d-flex justify-content-between border-bottom border-color-1 flex-lg-nowrap flex-wrap border-md-down-top-0 border-md-down-bottom-0">
                        ...
                        <a class="d-block text-gray-16" href="../shop/shop.html">Go to Trending products <i class="ec ec-arrow-right-categproes"></i></a>
                    </div>
                    <div class="js-slick-carousel u-slick overflow-hidden u-slick-overflow-visble pt-3 pb-6 px-1"
                        data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-4"
                        data-slides-show="7"
                ...
                <div class="mb-6">
                    <div class=" d-flex justify-content-between border-bottom border-color-1 flex-lg-nowrap flex-wrap border-md-down-top-0 border-md-down-bottom-0">
                        ...
                        <ul class="w-100 w-lg-auto nav nav-pills nav-tab-pill mb-2 pt-3 pt-lg-0 border-top border-color-1 border-lg-top-0 align-items-center font-size-15 font-size-15-lg flex-nowrap flex-lg-wrap overflow-auto overflow-lg-visble pr-0" id="pills-tab-4" role="tablist">
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill active" id="Apills-one-example1-tab" data-toggle="pill" href="#Apills-one-example1" role="tab" aria-controls="Apills-one-example1" aria-selected="true">Top 20</a>
                            </li>
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                            ...
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill" id="Apills-three-example1-tab" data-toggle="pill" href="#Apills-three-example1" role="tab" aria-controls="Apills-three-example1" aria-selected="false">Laptops</a>
                            </li>
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill" id="Apills-four-example1-tab" data-toggle="pill" href="#Apills-four-example1" role="tab" aria-controls="Apills-four-example1" aria-selected="false">Gaming</a>
                            </li>
                        </ul>
                    </div>
                    <!-- Tab Content -->
                    <div class="tab-content" id="Apills-tabContent">
                        ...
                        <div class="tab-pane fade pt-2" id="Apills-three-example1" role="tabpanel" aria-labelledby="Apills-three-example1-tab">
                            <div class="js-slick-carousel u-slick overflow-hidden u-slick-overflow-visble pt-3 pb-6 px-1"
                                data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-4"
                                data-slides-show="6"
                                data-slides-scroll="1"
                        ...
                        <div class="tab-pane fade pt-2" id="Apills-four-example1" role="tabpanel" aria-labelledby="Apills-four-example1-tab">
                            <div class="js-slick-carousel u-slick overflow-hidden u-slick-overflow-visble pt-3 pb-6 px-1"
                                data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-4"
                                data-slides-show="6"
                                data-slides-scroll="1"
                ...
                <div class="mb-6">
                    <div class=" d-flex justify-content-between border-bottom border-color-1 flex-lg-nowrap flex-wrap border-md-down-top-0 border-md-down-bottom-0">
                        ...
                        <ul class="w-100 w-lg-auto nav nav-pills nav-tab-pill mb-2 pt-3 pt-lg-0 border-top border-color-1 border-lg-top-0 align-items-center font-size-15 font-size-15-lg flex-nowrap flex-lg-wrap overflow-auto overflow-lg-visble pr-0" id="pills-tab-4" role="tablist">
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill active" id="Rpills-one-example1-tab" data-toggle="pill" href="#Rpills-one-example1" role="tab" aria-controls="Rpills-one-example1" aria-selected="true">Top 20</a>
                            </li>
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill" id="Rpills-two-example1-tab" data-toggle="pill" href="#Rpills-two-example1" role="tab" aria-controls="Rpills-two-example1" aria-selected="false">All in One</a>
                            </li>
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill" id="Rpills-three-example1-tab" data-toggle="pill" href="#Rpills-three-example1" role="tab" aria-controls="Rpills-three-example1" aria-selected="false">Laptops</a>
                            </li>
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill" id="Rpills-four-example1-tab" data-toggle="pill" href="#Rpills-four-example1" role="tab" aria-controls="Rpills-four-example1" aria-selected="false">Gaming</a>
                            </li>
                        </ul>
                    </div>
                    <!-- Tab Content -->
                    <div class="tab-content" id="Rpills-tabContent">
                        ...
                        <div class="tab-pane fade pt-2" id="Rpills-two-example1" role="tabpanel" aria-labelledby="Rpills-two-example1-tab">
                            <div class="js-slick-carousel u-slick overflow-hidden u-slick-overflow-visble pt-3 pb-6 px-1"
                                data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-4"
                                data-slides-show="6"
                                data-slides-scroll="1"
                        ...
                        <div class="tab-pane fade pt-2" id="Rpills-three-example1" role="tabpanel" aria-labelledby="Rpills-three-example1-tab">
                            <div class="js-slick-carousel u-slick overflow-hidden u-slick-overflow-visble pt-3 pb-6 px-1"
                                data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-4"
                                data-slides-show="6"
                                data-slides-scroll="1"
                        ...
                        <div class="tab-pane fade pt-2" id="Rpills-four-example1" role="tabpanel" aria-labelledby="Rpills-four-example1-tab">
                            <div class="js-slick-carousel u-slick overflow-hidden u-slick-overflow-visble pt-3 pb-6 px-1"
                                data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-4"
                                data-slides-show="6"
                                data-slides-scroll="1"
                ...
                <div class="mb-6">
                    <div class="d-flex justify-content-between border-bottom border-color-1 flex-lg-nowrap flex-wrap border-md-down-top-0 border-md-down-bottom-0">
                        ...
                        <ul class="w-100 w-lg-auto nav nav-pills nav-tab-pill mb-2 pt-3 pt-lg-0 border-top border-color-1 border-lg-top-0 align-items-center font-size-15 font-size-15-lg flex-nowrap flex-lg-wrap overflow-auto overflow-lg-visble pr-0" id="pills-tab-4" role="tablist">
                            ...
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill" id="Ypills-two-example1-tab" data-toggle="pill" href="#Ypills-two-example1" role="tab" aria-controls="Ypills-two-example1" aria-selected="false">Curved TVs</a>
                            </li>
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill" id="Ypills-three-example1-tab" data-toggle="pill" href="#Ypills-three-example1" role="tab" aria-controls="Ypills-three-example1" aria-selected="false">Smart TVs</a>
                            </li>
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill" id="Ypills-four-example1-tab" data-toggle="pill" href="#Ypills-four-example1" role="tab" aria-controls="Ypills-four-example1" aria-selected="false">LED TVs</a>
                            </li>
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill" id="Ypills-five-example1-tab" data-toggle="pill" href="#Ypills-five-example1" role="tab" aria-controls="Ypills-five-example1" aria-selected="false">3D Tvs</a>
                            </li>
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill" id="Ypills-six-example1-tab" data-toggle="pill" href="#Ypills-six-example1" role="tab" aria-controls="Ypills-six-example1" aria-selected="false">OLED TVs</a>
                            </li>
                        </ul>
                    </div>
                    <!-- Tab Content -->
                    <div class="tab-content" id="Ypills-tabContent">
                                        ...
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner p-md-3 row no-gutters">
                                                <div class="col col-lg-5 product-media-left">
                                                    <a href="../shop/single-product-fullwidth.html" class="max-width-150 d-block" tabindex="0"><img class="img-fluid" src="../../assets/img/150X140/img1.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                    <div class="mb-4">
                                                        ...
                                                        <h5 class="product-item__title"><a href="../shop/single-product-fullwidth.html" class="text-blue font-weight-bold" tabindex="0">Tablet Air 3 WiFi 64GB Gold</a></h5>
                                                    </div>
                                ...
                                <div class="js-slide products-group">
                                    <div class="product-item product-item__card">
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner p-md-3 row no-gutters">
                                                <div class="col col-lg-5 product-media-left">
                                                    <a href="../shop/single-product-fullwidth.html" class="max-width-150 d-block" tabindex="0"><img class="img-fluid" src="../../assets/img/150X140/img2.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                    <div class="mb-4">
                                                        ...
                                                        <h5 class="product-item__title"><a href="../shop/single-product-fullwidth.html" class="text-blue font-weight-bold" tabindex="0">Tablet White EliteBook  Revolve 810 G2</a></h5>
                                                    </div>
                                                    <div class="flex-center-between mb-3">
                                                        <div class="prodcut-price">
                                ...
                                <div class="js-slide products-group">
                                    <div class="product-item product-item__card">
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner p-md-3 row no-gutters">
                                                <div class="col col-lg-5 product-media-left">
                                                    <a href="../shop/single-product-fullwidth.html" class="max-width-150 d-block" tabindex="0"><img class="img-fluid" src="../../assets/img/150X140/img3.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                    <div class="mb-4">
                                                        ...
                                                        <h5 class="product-item__title"><a href="../shop/single-product-fullwidth.html" class="text-blue font-weight-bold" tabindex="0">Pendrive USB 3.0 Flash 64 GB</a></h5>
                                                    </div>
                                                    <div class="flex-center-between mb-3">
                                                        <div class="prodcut-price">
                                ...
                                <div class="js-slide products-group">
                                    <div class="product-item product-item__card">
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner p-md-3 row no-gutters">
                                                <div class="col col-lg-5 product-media-left">
                                                    <a href="../shop/single-product-fullwidth.html" class="max-width-150 d-block" tabindex="0"><img class="img-fluid" src="../../assets/img/150X140/img6.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                    <div class="mb-4">
                                                        ...
                                                        <h5 class="product-item__title"><a href="../shop/single-product-fullwidth.html" class="text-blue font-weight-bold" tabindex="0">External SSD USB 3.1 750 GB</a></h5>
                                                    </div>
                                                    <div class="flex-center-between mb-3">
                                                        <div class="prodcut-price">
                                                            <div class="text-gray-100">$799,00</div>
                        ...
                        <div class="tab-pane fade pt-2" id="Ypills-two-example1" role="tabpanel" aria-labelledby="Ypills-two-example1-tab">
                            <div class="js-slick-carousel u-slick overflow-hidden u-slick-overflow-visble pt-3 pb-6 px-1"
                                data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-4"
                                data-slides-show="4"
                                data-slides-scroll="1"
                        ...
                        <div class="tab-pane fade pt-2" id="Ypills-three-example1" role="tabpanel" aria-labelledby="Ypills-three-example1-tab">
                            <div class="js-slick-carousel u-slick overflow-hidden u-slick-overflow-visble pt-3 pb-6 px-1"
                                data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-4"
                                data-slides-show="4"
                                data-slides-scroll="1"
                        ...
                        <div class="tab-pane fade pt-2" id="Ypills-four-example1" role="tabpanel" aria-labelledby="Ypills-four-example1-tab">
                            <div class="js-slick-carousel u-slick overflow-hidden u-slick-overflow-visble pt-3 pb-6 px-1"
                                data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-4"
                                data-slides-show="4"
                                data-slides-scroll="1"
                        ...
                        <div class="tab-pane fade pt-2" id="Ypills-five-example1" role="tabpanel" aria-labelledby="Ypills-five-example1-tab">
                            <div class="js-slick-carousel u-slick overflow-hidden u-slick-overflow-visble pt-3 pb-6 px-1"
                                data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-4"
                                data-slides-show="4"
                                data-slides-scroll="1"
                        ...
                        <div class="tab-pane fade pt-2" id="Ypills-six-example1" role="tabpanel" aria-labelledby="Ypills-six-example1-tab">
                            <div class="js-slick-carousel u-slick overflow-hidden u-slick-overflow-visble pt-3 pb-6 px-1"
                                data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-4"
                                data-slides-show="4"
                                data-slides-scroll="1"
                                ...
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block  pr-2 pr-wd-6">
                                    <div class="media align-items-center">
                                        <div class="max-width-148">
                                            <img class="img-fluid transform-rotate-15" src="../../assets/img/300X300/img9.png" alt="Image Description">
                                        </div>
                                        <div class="ml-4 media-body">
                                            <h4 class="mb-0 text-gray-90">Home &amp; Audio Enternteinment</h4>
                                        </div>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="col-md-6 col-xl-4 mb-5 flex-shrink-0 flex-md-shrink-1">
                            <div class="bg-gray-1 overflow-hidden shadow-on-hover h-100 d-flex align-items-center">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block  pr-2 pr-wd-6">
                                    <div class="media align-items-center">
                                        <div class="max-width-148">
                                            <img class="img-fluid transform-rotate-15" src="../../assets/img/300X300/img10.png" alt="Image Description">
                                        </div>
                                        <div class="ml-4 media-body">
                                            <h4 class="mb-0 text-gray-90">Smartphones & Tablets</h4>
                                        </div>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="col-md-6 col-xl-4 mb-5 flex-shrink-0 flex-md-shrink-1">
                            <div class="bg-gray-1 overflow-hidden shadow-on-hover h-100 d-flex align-items-center">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block  pr-2 pr-wd-6">
                                    <div class="media align-items-center">
                                        <div class="max-width-148">
                                            <img class="img-fluid transform-rotate-15" src="../../assets/img/300X300/img11.png" alt="Image Description">
                                        </div>
                                        <div class="ml-4 media-body">
                                            <h4 class="mb-0 text-gray-90">Desktop PCs & Laptops</h4>
                                        </div>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="col-md-6 col-xl-4 mb-5 flex-shrink-0 flex-md-shrink-1">
                            <div class="bg-gray-1 overflow-hidden shadow-on-hover h-100 d-flex align-items-center">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block  pr-2 pr-wd-6">
                                    <div class="media align-items-center">
                                        <div class="max-width-148">
                                            <img class="img-fluid transform-rotate-15" src="../../assets/img/300X300/img12.png" alt="Image Description">
                                        </div>
                                        <div class="ml-4 media-body">
                                            <h4 class="mb-0 text-gray-90">Video Games & Consoles</h4>
                                        </div>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="col-md-6 col-xl-4 mb-5 flex-shrink-0 flex-md-shrink-1">
                            <div class="bg-gray-1 overflow-hidden shadow-on-hover h-100 d-flex align-items-center">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block  pr-2 pr-wd-6">
                                    <div class="media align-items-center">
                                        <div class="max-width-148">
                                            <img class="img-fluid transform-rotate-15" src="../../assets/img/300X300/img13.png" alt="Image Description">
                                        </div>
                                        <div class="ml-4 media-body">
                                            <h4 class="mb-0 text-gray-90">Gadgets & Accesories</h4>
                                        </div>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="col-md-6 col-xl-4 mb-5 flex-shrink-0 flex-md-shrink-1">
                            <div class="bg-gray-1 overflow-hidden shadow-on-hover h-100 d-flex align-items-center">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block  pr-2 pr-wd-6">
                                    <div class="media align-items-center">
                                        <div class="max-width-148">
                                            <img class="img-fluid transform-rotate-15" src="../../assets/img/300X300/img14.png" alt="Image Description">
                                        </div>
                                        <div class="ml-4 media-body">
                                            <h4 class="mb-0 text-gray-90">Photo Cameras</h4>
                                        </div>
                                    </div>
                                </a>
                            </div>
                ...
                <div class="mb-6">
                    <div class="row">
                        <div class="col-lg-8 mb-5">
                            <div class="bg-gray-17">
                                <a href="../shop/shop.html" class="row align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <img class="img-fluid" src="../../assets/img/446X262/img1.jpg" alt="Image Description">
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-5">
                            <div class="h-100">
                                <a href="../shop/shop.html" class="d-block"><img class="img-fluid" src="../../assets/img/446X262/img3.jpg" alt="Image Description"></a>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-5">
                            <a href="../shop/shop.html" class=""><img class="img-fluid" src="../../assets/img/446X262/img4.jpg" alt="Image Description"></a>
                        </div>
                        <div class="col-lg-8 mb-5">
                            <div class="bg-gray-1">
                                <a href="../shop/shop.html" class="row align-items-center">
                                    <div class="col-md-6 mb-4 mb-md-0">
                                        <img class="img-fluid" src="../../assets/img/446X262/img2.jpg" alt="Image Description">
                                    </div>
                                    <div class="col-md-6 mb-4 mb-md-0">
                                ...
                                <ul id="headerSidebarList" class="u-header-collapse__nav">
                                    ...
                                    <li class="u-has-submenu u-header-collapse__submenu">
                                        ...
                                        <div id="headerSidebarComputersCollapse" class="collapse" data-parent="#headerSidebarContent">
                                            <ul class="u-header-collapse__nav-list">
                                                ...
                                                <li class=""><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Computers & Accessories</a></li>
                                                <li class=""><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Laptops, Desktops & Monitors</a></li>
                                                <li class=""><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Printers & Ink</a></li>
                                                <li class=""><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Networking & Internet Devices</a></li>
                                                <li class=""><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Computer Accessories</a></li>
                                                <li class=""><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Software</a></li>
                                                <li><span class="u-header-sidebar__sub-menu-title">Office & Stationery</span></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Office & Stationery</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Electronics</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li class="u-has-submenu u-header-collapse__submenu">
                                        ...
                                        <div id="headerSidebarCamerasCollapse" class="collapse" data-parent="#headerSidebarContent">
                                            <ul class="u-header-collapse__nav-list">
                                                ...
                                                <li class=""><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Lenses</a></li>
                                                <li class=""><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Camera Accessories</a></li>
                                                <li class=""><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Security & Surveillance</a></li>
                                                <li class=""><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Binoculars & Telescopes</a></li>
                                                <li class=""><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Camcorders</a></li>
                                                <li class=""><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Software</a></li>
                                                <li><span class="u-header-sidebar__sub-menu-title">Audio & Video</span></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Audio & Video</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Headphones & Speakers</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Electronics</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li class="u-has-submenu u-header-collapse__submenu">
                                        ...
                                        <div id="headerSidebarMobilesCollapse" class="collapse" data-parent="#headerSidebarContent">
                                            <ul class="u-header-collapse__nav-list">
                                                ...
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Mobile Phones</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Smartphones</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Refurbished Mobiles</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Cases & Covers</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Mobile Accessories</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Cases & Covers</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Tablets</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Tablet Accessories</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Electronics</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li class="u-has-submenu u-header-collapse__submenu">
                                        ...
                                        <div id="headerSidebarMoviesCollapse" class="collapse" data-parent="#headerSidebarContent">
                                            <ul class="u-header-collapse__nav-list">
                                                ...
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Movies & TV Shows</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All English</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Hindi</a></li>
                                                <li><span class="u-header-sidebar__sub-menu-title">Video Games</span></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">PC Games</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Consoles</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Accessories</a></li>
                                                <li><span class="u-header-sidebar__sub-menu-title">Music</span></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Music</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Indian Classical</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Musical Instruments</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li class="u-has-submenu u-header-collapse__submenu">
                                        ...
                                        <div id="headerSidebarTvCollapse" class="collapse" data-parent="#headerSidebarContent">
                                            <ul class="u-header-collapse__nav-list">
                                                <li><span class="u-header-sidebar__sub-menu-title">Audio & Video</span></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Audio & Video</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Televisions</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Headphones</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Speakers</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Audio & Video Accessories</a></li>
                                                <li><span class="u-header-sidebar__sub-menu-title">Music</span></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Televisions</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Headphones</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Electro Home Appliances</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    <!-- End TV & Audio -->
                                    ...
                                    <li class="u-has-submenu u-header-collapse__submenu">
                                        ...
                                        <div id="headerSidebarWatchesCollapse" class="collapse" data-parent="#headerSidebarContent">
                                            <ul class="u-header-collapse__nav-list">
                                                ...
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Watches</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Men's Watches</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Women's Watches</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Premium Watches</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Deals on Watches</a></li>
                                                <li><span class="u-header-sidebar__sub-menu-title">Eyewear</span></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Men's Sunglasses</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    <!-- End Watches & Eyewear -->
                                    ...
                                    <li class="u-has-submenu u-header-collapse__submenu">
                                        ...
                                        <div id="headerSidebarCarCollapse" class="collapse" data-parent="#headerSidebarContent">
                                            <ul class="u-header-collapse__nav-list">
                                                ...
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Cars & Bikes</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Car & Bike Care</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Lubricants</a></li>
                                                <li><span class="u-header-sidebar__sub-menu-title">Shop for Bike</span></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Helmets & Gloves</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Bike Parts</a></li>
                                                <li><span class="u-header-sidebar__sub-menu-title">Industrial Supplies</span></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Industrial Supplies</a></li>
                                    ...
                                    <li class="u-has-submenu u-header-collapse__submenu">
                                        ...
                                        <div id="headerSidebarAccessoriesCollapse" class="collapse" data-parent="#headerSidebarContent">
                                            <ul class="u-header-collapse__nav-list">
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Cases</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Chargers</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Headphone Accessories</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Headphone Cases</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Headphones</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">All Industrial Supplies</a></li>
                                                <li><a class="u-header-collapse__submenu-nav-link" href="javascript:;">Lab & Scientific</a></li>
                                            </ul>
                    ...
                    <footer id="SVGwaveWithDots" class="svg-preloader u-header-sidebar__footer">
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item pr-3">
                                <a class="u-header-sidebar__footer-link text-gray-90" href="javascript:;">Privacy</a>
                            </li>
                            <li class="list-inline-item pr-3">
                                <a class="u-header-sidebar__footer-link text-gray-90" href="javascript:;">Terms</a>
                            </li>
                            <li class="list-inline-item">
                                <a class="u-header-sidebar__footer-link text-gray-90" href="javascript:;">
