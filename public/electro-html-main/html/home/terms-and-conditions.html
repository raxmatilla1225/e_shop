...
<html lang="en">
    <head>
        <!-- Title -->
        <title>Terms and Conditions | Electro - Responsive Website Template</title>
        ...
        <main id="content" role="main">
            ...
            <div class="container">
                ...
                <div class="mb-10">
                    ...
                    <p class="text-gray-90">If you have any questions about this Agreement, please contact us filling this <a href="javascript:;" class="text-blue font-weight-bold">contact form</a></p>
                </div>
                <!-- Brand Carousel -->
                <div class="mb-8">
